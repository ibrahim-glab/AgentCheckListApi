    ...
    public class RegisteratoinService : IRegisterationService
    {
        ...
        public ServiceResult RegisterUser(User user, Permission permission)
        {
            ...
            catch (System.Exception e)
            {
                ...
                return new ServiceResult { Message = e.Message };
            }
        }
        ...
        private bool IsUserAlreadyRegistered(string phoneNumber, string nationalId, string username = "")
        {
